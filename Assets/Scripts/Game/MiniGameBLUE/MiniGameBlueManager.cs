...
public class MiniGameBlueManager : MonoBehaviour, IGameManager
{
    ...
    [SerializeField] private GameObject _swipeControlPanel;
    ...
    void Start()
    {
        ...
        _swipeControlPanel.SetActive(false);
        TimeRemaining = 0f;
        Time.timeScale = 0.0f;
    }
    private void Update()
    ...
    public void StartGame()
    {
        ...
        _swipeControlPanel.SetActive(true);
        Time.timeScale = 1.0f;
    }
    public void EndGame()
    {
